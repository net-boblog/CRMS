...
CREATE TABLE `menu` (
  ...
  PRIMARY KEY (`menu_id`),
  KEY `FK_menu_ps` (`pid`),
  CONSTRAINT `FK_menu_ps` FOREIGN KEY (`pid`) REFERENCES `menu` (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('1', '1', '用户管理', '/url', '0');
INSERT INTO `menu` VALUES ('2', '2', '角色管理', null, null);
INSERT INTO `menu` VALUES ('3', '3', '视频管理', '/filec/init.htm', null);
INSERT INTO `menu` VALUES ('4', '4', '审核流程', null, null);
INSERT INTO `menu` VALUES ('5', '4', '活动任务', null, null);
INSERT INTO `menu` VALUES ('6', '4', '历史任务', null, null);
...
-- ----------------------------
INSERT INTO `operation` VALUES ('1', '用户管理', 'url.htm', '功能说明', '0');
INSERT INTO `operation` VALUES ('2', '用户新增', '', '', '1');
INSERT INTO `operation` VALUES ('3', '用户编辑', '', '', '1');
INSERT INTO `operation` VALUES ('4', '用户删除', ' ', ' ', '1');
INSERT INTO `operation` VALUES ('5', '拉黑用户', ' ', ' ', '1');
INSERT INTO `operation` VALUES ('6', '解除拉黑', ' ', ' ', '1');
INSERT INTO `operation` VALUES ('7', '角色管理', ' ', ' ', '0');
INSERT INTO `operation` VALUES ('8', '角色新增', null, null, '7');
INSERT INTO `operation` VALUES ('9', '角色删除', null, null, '7');
INSERT INTO `operation` VALUES ('10', '角色编辑', null, null, '7');
INSERT INTO `operation` VALUES ('11', '角色查询', null, null, '7');
INSERT INTO `operation` VALUES ('12', '角色菜单新增', null, null, '7');
INSERT INTO `operation` VALUES ('13', '视频管理', null, null, '0');
INSERT INTO `operation` VALUES ('14', '视频新增', null, null, '13');
INSERT INTO `operation` VALUES ('15', '视频删除', null, null, '13');
INSERT INTO `operation` VALUES ('16', '视频修改', null, null, '13');
INSERT INTO `operation` VALUES ('17', '活动任务', null, null, '0');
INSERT INTO `operation` VALUES ('18', '活动删除', null, null, '17');
INSERT INTO `operation` VALUES ('19', '活动新增', null, null, '17');
INSERT INTO `operation` VALUES ('20', '活动编辑', null, null, '17');
INSERT INTO `operation` VALUES ('21', '历史任务', null, null, '0');
INSERT INTO `operation` VALUES ('22', '任务编辑', null, null, '21');
INSERT INTO `operation` VALUES ('23', '任务删除', null, null, '21');
INSERT INTO `operation` VALUES ('24', '任务新增', null, null, '21');
...
CREATE TABLE `role_menu` (
  ...
  KEY `FK_role_menu2` (`role_id`),
  CONSTRAINT `FK_role_menu` FOREIGN KEY (`menu_id`) REFERENCES `menu` (`menu_id`),
  CONSTRAINT `FK_role_menu2` FOREIGN KEY (`role_id`) REFERENCES `role` (`role_id`)
...
CREATE TABLE `role_operation` (
  ...
  KEY `FK_role_operation2` (`role_id`),
  CONSTRAINT `FK_role` FOREIGN KEY (`operation_id`) REFERENCES `operation` (`operation_id`),
  CONSTRAINT `FK_role_operation` FOREIGN KEY (`role_id`) REFERENCES `role` (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `role_operation` VALUES ('2', '1');
...
INSERT INTO `role_operation` VALUES ('7', '1');
INSERT INTO `role_operation` VALUES ('8', '1');
INSERT INTO `role_operation` VALUES ('9', '1');
INSERT INTO `role_operation` VALUES ('10', '1');
INSERT INTO `role_operation` VALUES ('11', '1');
INSERT INTO `role_operation` VALUES ('12', '1');
INSERT INTO `role_operation` VALUES ('13', '1');
INSERT INTO `role_operation` VALUES ('14', '1');
INSERT INTO `role_operation` VALUES ('15', '1');
INSERT INTO `role_operation` VALUES ('16', '1');
INSERT INTO `role_operation` VALUES ('17', '1');
INSERT INTO `role_operation` VALUES ('18', '1');
INSERT INTO `role_operation` VALUES ('19', '1');
INSERT INTO `role_operation` VALUES ('20', '1');
...
CREATE TABLE `user` (
  ...
  `user_descript` varchar(512) DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '1', 'admin', '21232F297A57A5A743894A0E4A801FC3', '我是超级管理员', '0', null, null, null, null);
...
CREATE TABLE `user_file` (
  ...
  `bussinessKey` varchar(200) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_user_file2` (`user_id`),
